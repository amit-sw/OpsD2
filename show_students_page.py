...
from supabase_integration import get_supabase_client, get_students_from_db
...
def show_student_details(student_name, students, calendar_service):
    ...
    with st.spinner("Fetching calendar events..."):
        student_events = get_events_for_emails(calendar_service, student_specific_emails)
...
def show_students_page():
    ...
    if st.session_state.selected_student:
        ...
        show_student_details(st.session_state.selected_student, students, calendar_service)
    else:
        st.title("Students")
